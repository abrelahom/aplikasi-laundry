...
//    }
    ...
    private void initComponents() {
        ...
        hapus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Erase.png"))); // NOI18N
        ...
        jLabel13.setFont(new java.awt.Font("Javanese Text", 1, 24)); // NOI18N
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_Close_Window_48px.png"))); // NOI18N
    ...
    private void tbl_beliMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_beliMouseClicked
        ...
        j_pewangi.setSelectedItem(tabmodel.getValueAt(tbl_beli.getSelectedRow(),4 ) + "");
        jumlah.setText(tabmodel.getValueAt(tbl_beli.getSelectedRow(), 5) + "");
        nama.setText(tabmodel.getValueAt(tbl_beli.getSelectedRow(), 1) + "");
        no_telp.setText(tabmodel.getValueAt(tbl_beli.getSelectedRow(), 2) + "");
        alamat.setText(tabmodel.getValueAt(tbl_beli.getSelectedRow(), 3) + "");
